...
public class InMemoryWorldDao implements WorldDao {
	...
	public static void main(String args[]) {
		...
		List<City> maxCities = worldDao.getCountries().values().stream()
		...
		System.out.println("==============================================");
		//List<City> maxCitiesCont = worldDao.getContinents().values().stream()
					
		List<City> maxContent = worldDao.getContinents().stream()
								.map(o -> worldDao.findCountriesByContinent(o).stream()
								.map(c -> c.getCities().stream()
								.max(Comparator.comparingInt(City::getPopulation)))
		...
		City maxCapital = worldDao.getCountries().values().stream()
							.map(x -> x.getCities().stream()
							.filter(c -> c.getId() == x.getCapital())
							.findAny())
							.flatMap(Optional::stream)
